                            ...
                            @endif
                                <form action="{{route('tugas.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="optionid_kategori" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div> -->
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-selectinput" class=" form-control-label">Keterangan Tugas</label></div>
