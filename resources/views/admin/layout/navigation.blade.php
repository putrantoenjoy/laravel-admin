            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        ...
                        <a href="{{url('/admin/projek')}}"> <i class="menu-icon fa fa-dashboard"></i>projek </a>
                        @role('admin')
                        <a href="{{url('/admin/role')}}"> <i class="menu-icon fa fa-dashboard"></i>Role </a>
                        <a href="{{url('/admin/user')}}"> <i class="menu-icon fa fa-dashboard"></i>User </a>
                        @endrole
                    </li>
