                        ...
                        <div class="card">
                            ...
                            @endif
                                <form action="{{route('tugas.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama UTS</label></div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col col-md-9">
                                                <div class="form-check-inline form-check">
                                                    <label for="radiostatus_tugas" class="form-check-label ">
                                                        <input type="radio" id="radiostatus_tugas" name="radiostatus_tugas" value="0" class="form-check-input">Masih Berjalan
                                                    </label>
                                                    <label for="inline-radio2" class="form-check-label ">
                                                        <input type="radio" id="radiostatus_tugas" name="radiostatus_tugas" value="1" class="form-check-input">Selesai
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
