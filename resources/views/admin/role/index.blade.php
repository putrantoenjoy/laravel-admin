                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{route('role.create')}}" class="btn btn-primary pull-right">Tambah</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('role.edit',$row->id)}}" class="btn btn-primary">Edit</a></td>
                                            <td><form action="{{route('role.destroy', $row->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
